...
import PPADashboardNavbar from '../../../../../components/dashboard/lagos-state-dashboard/ppa-dashboard/DashboardNavbar';
import PPADashboardSidebar from '../../../../../components/dashboard/lagos-state-dashboard/ppa-dashboard/DashboardSidebar';
import PPADashboardContent from '../../../../../components/dashboard/lagos-state-dashboard/ppa-dashboard/DashboardContent';
...
export default function PPADashboardPage() {
  ...
  useEffect(() => {
    const checkAuth = () => {
      ...
      if (!token || !storedPpa) {
        localStorage.setItem('nysc_ppa_token', 'lagos_ppa_token_' + Date.now());
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-white dark:bg-gray-900">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-300">Loading Lagos PPA Dashboard...</p>
        </div>
      </div>
    );
  }
