...
import LGIDashboardNavbar from '../../../../../components/dashboard/lagos-state-dashboard/lgi-dashboard/DashboardNavbar';
import LGIDashboardSidebar from '../../../../../components/dashboard/lagos-state-dashboard/lgi-dashboard/DashboardSidebar';
import LGIDashboardContent from '../../../../../components/dashboard/lagos-state-dashboard/lgi-dashboard/DashboardContent';
...
export default function LGIDashboardPage() {
  ...
  useEffect(() => {
    const checkAuth = () => {
      ...
      if (!token || !storedLgi) {
        localStorage.setItem('nysc_lgi_token', 'lagos_lgi_token_' + Date.now());
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-white dark:bg-gray-900">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-300">Loading Lagos LGI Dashboard...</p>
        </div>
      </div>
    );
  }
