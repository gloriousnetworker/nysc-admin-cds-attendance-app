  ...
  useEffect(() => {
    const checkAuth = () => {
      ...
      if (!token || !storedZonal) {
        localStorage.setItem('nysc_zonal_token', 'lagos_zonal_token_' + Date.now());
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-white dark:bg-gray-900">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-300">Loading Lagos Zonal Inspector Dashboard...</p>
        </div>
      </div>
    );
  }
