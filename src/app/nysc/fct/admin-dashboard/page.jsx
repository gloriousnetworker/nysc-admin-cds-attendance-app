...
import AdminDashboardNavbar from '../../../../components/dashboard/fct-dashboard/admin-dashboard/DashboardNavbar';
import AdminDashboardSidebar from '../../../../components/dashboard/fct-dashboard/admin-dashboard/DashboardSidebar';
import AdminDashboardContent from '../../../../components/dashboard/fct-dashboard/admin-dashboard/DashboardContent';
...
export default function AdminDashboardPage() {
  ...
  useEffect(() => {
    const checkAuth = () => {
      const mockAdminData = {
        adminId: 'FCT-ADM-001',
        fullName: 'FCT Super Administrator',
        email: 'admin.fct@nysc.gov.ng',
        role: 'FCT Super Admin',
        permissions: ['all'],
        state: 'FCT Abuja',
      ...
      if (!token || !storedAdmin) {
        localStorage.setItem('nysc_admin_token', 'fct_admin_token_' + Date.now());
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-white dark:bg-gray-900">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-300">Loading FCT Admin Dashboard...</p>
        </div>
      </div>
    );
  }
