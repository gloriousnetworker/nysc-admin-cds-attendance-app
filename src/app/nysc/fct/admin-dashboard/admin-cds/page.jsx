...
import CDSDashboardNavbar from '../../../../../components/dashboard/fct-dashboard/cds-dashboard/DashboardNavbar';
import CDSDashboardSidebar from '../../../../../components/dashboard/fct-dashboard/cds-dashboard/DashboardSidebar';
import CDSDashboardContent from '../../../../../components/dashboard/fct-dashboard/cds-dashboard/DashboardContent';
...
export default function CDSDashboardPage() {
  ...
  useEffect(() => {
    const checkAuth = () => {
      ...
      if (!token || !storedCds) {
        localStorage.setItem('nysc_cds_token', 'fct_cds_token_' + Date.now());
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-white dark:bg-gray-900">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-300">Loading FCT CDS Dashboard...</p>
        </div>
      </div>
    );
  }
