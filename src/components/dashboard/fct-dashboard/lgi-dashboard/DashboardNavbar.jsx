        ...
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center">
            <div className="flex items-center">
              ...
              <div>
                <div className="font-bold text-lg text-[#008753] dark:text-green-400">FCT Local Government Inspector</div>
                <div className="text-xs text-gray-600 dark:text-gray-400">{lgiData?.localGovernment}, {lgiData?.state}</div>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-3">
            <div className="hidden sm:flex items-center space-x-2 px-3 py-1 bg-blue-50 dark:bg-blue-900/30 rounded-lg">
              ...
              <span className="text-xs font-medium text-blue-700 dark:text-blue-300">Zone {lgiData?.zone || '4'}</span>
            </div>
            ...
            <div className="hidden sm:flex items-center space-x-3">
              <div className="text-right">
                ...
                <div className="text-xs text-gray-600 dark:text-gray-300">FCT LGI - {lgiData?.localGovernment}</div>
              </div>
          ...
          <div className="md:hidden py-4 border-t border-gray-200 dark:border-gray-700">
            <div className="flex items-center justify-center mb-4">
              <div className="px-3 py-1 bg-blue-50 dark:bg-blue-900/30 rounded-lg">
                <span className="text-sm font-medium text-blue-700 dark:text-blue-300">FCT Zone {lgiData?.zone || '4'}</span>
              </div>
            </div>
