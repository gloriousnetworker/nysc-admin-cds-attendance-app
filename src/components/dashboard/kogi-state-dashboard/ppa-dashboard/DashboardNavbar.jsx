        ...
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center">
            <div className="flex items-center">
              ...
              <div>
                <div className="font-bold text-lg text-[#006600] dark:text-green-500">Kogi PPA Dashboard</div>
                <div className="text-xs text-gray-600 dark:text-gray-400">Confluence State Portal - {ppaData?.organization}</div>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-3">
            <div className="hidden sm:flex items-center space-x-2 px-3 py-1 bg-gradient-to-r from-[#FF9900] to-[#FFAA33] rounded-lg">
              ...
              <span className="text-xs font-medium text-white">Kogi PPA</span>
            </div>
          ...
          <div className="md:hidden py-4 border-t border-gray-200 dark:border-gray-700">
            <div className="flex items-center justify-center mb-4">
              <div className="px-3 py-1 bg-gradient-to-r from-[#FF9900] to-[#FFAA33] rounded-lg">
                <span className="text-sm font-medium text-white">Kogi PPA</span>
              </div>
            </div>
